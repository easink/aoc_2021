defmodule AoCDay08Test do
  ...
  test "part1" do
    assert AoC.Day08.part1(@test_input) == 26
    assert AoC.Day08.part1(@input) == 352
  end

  test "part2" do
    assert AoC.Day08.part2(@example) == 5353
    assert AoC.Day08.part2(@test_input) == 61229
    assert AoC.Day08.part2(@input) == 936_117
  end
end
